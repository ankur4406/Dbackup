...
def reference_config(img_form, config_file_in):
    ...
    for key in dict_config.keys():
        ...
        if dict_config[key]["type"] == 'tbl':
            y1 = dict_config[key]["coordinates"]["y1"] - (50)
            y2 = dict_config[key]["coordinates"]["y1"]
        ...
        if dict_config[key]["type"] == 'tbl':
            ...
            y2_ = dict_config[key]["coordinates"]["y2"] + (50)
            # Encode the marker into a base64 string
            ...
            in_mem_file.seek(0)
            img_bytes = in_mem_file.read()
            ref_marker_encoded_ = base64.encodebytes(img_bytes).decode('utf-8')
        else:
